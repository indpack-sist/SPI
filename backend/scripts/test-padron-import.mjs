...
check('TAB objetivo (logística) → Logística / Almacenes', clasificarObjetivo(pt)?.sector === 'Logística / Almacenes');

console.log('clasificarObjetivo (todos los sectores; agro solo fruta/verdura):');
